...
function PageLink({ page }: { page: Page }) {
  return (
    <article key={page.href}>
      ...
      >
        <h3 className="mt-6 text-base font-medium text-neutral-950">
          {page.title}
        </h3>
        <time
          dateTime={page.date}
        ...
        <Link
          href={page.href}
          className="mt-6 flex gap-x-3 text-base font-medium text-neutral-950 transition hover:text-neutral-700"
...
export function PageLinks({
  ...
  return (
    <div className={clsx('relative pt-24 sm:pt-32 lg:pt-40', className)}>
      <div className="bg-linear-to-b absolute inset-x-0 top-0 -z-10 h-[884px] overflow-hidden rounded-t-4xl from-neutral-50">
        <GridPattern
