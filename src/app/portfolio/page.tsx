...
const projects = [
  ...
  },
  {
    ...
    description:
      'Comprehensive infrastructure-as-code solution for managing deployments, scaling, and monitoring. Implements best practices for CI/CD, containerization, and cloud-native architecture across multiple environments.',
    techStack: ['Kubernetes', 'Terraform', 'Docker', 'GitHub Actions', 'AWS/GCP'],
    features: [
