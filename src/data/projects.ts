...
export const projectDetails: Record<string, ProjectDetail> = {
  ...
  'evaluation-exploration': {
    ...
    shortDescription:
      'A comprehensive testing and evaluation framework for AI models.',
    fullDescription:
      'Evaluation Exploration is a comprehensive testing and evaluation framework designed specifically for AI and machine learning models. The platform provides automated testing, performance benchmarking, and detailed analytics for machine learning pipelines. Built with MLflow integration and modern DevOps practices, it enables teams to track experiments, compare model performance, and make data-driven decisions.',
    problem:
      'Evaluating and comparing AI models is a complex, time-consuming process. Teams struggle with tracking experiments, comparing model versions, and understanding performance metrics. Without proper evaluation frameworks, it\'s difficult to identify the best models, detect regressions, or make informed decisions about model deployment. Manual evaluation processes are error-prone and don\'t scale.',
    solution:
      'Evaluation Exploration automates the entire model evaluation workflow. The platform integrates with MLflow for experiment tracking, provides automated A/B testing frameworks, and generates comprehensive performance reports. Teams can easily compare models, track metrics over time, and identify the best-performing models for production deployment.',
    whatWeDid: [
      'Built MLflow integration for experiment tracking',
      'Developed automated evaluation pipelines',
      'Created A/B testing framework for model comparison',
      'Built performance monitoring dashboard with React',
      'Implemented Docker containerization for reproducible environments',
      'Created Kubernetes deployment configurations',
      'Developed comprehensive reporting system',
    ],
    techStack: ['Python', 'MLflow', 'Docker', 'Kubernetes', 'React', 'FastAPI', 'PostgreSQL'],
    features: [
